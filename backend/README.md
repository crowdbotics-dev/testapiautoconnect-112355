...
## Project Structure
    ...
    ├── testapiautoconnect_112355  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112355`
...
2. Clone this repo and `cd testapiautoconnect_112355`
